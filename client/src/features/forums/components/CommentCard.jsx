...
const CommentCard = ({ comment, onReplyClick, isReply = false }) => {
  console.log("commenCard", comment);
  ...
  return (
    <Card
      className={`border-none shadow-md hover:shadow-lg transition-shadow duration-300 ${
        isReply ? "bg-gray-50 dark:bg-gray-900" : ""
      }`}
    >
      <div className="p-4">
        <div className="flex items-start gap-3">
          <Avatar
            ...
            } ring-2 ring-purple-100 dark:ring-purple-900`}
          >
            {comment?.commentedBy?.photoUrl ? (
              <img
                src={comment?.commentedBy?.photoUrl || "/placeholder.svg"}
